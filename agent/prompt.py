...
5. **다국어 응답 및 시스템 언어 보존 규칙 (Multi-lingual Matching & System Language Policy)**:
   - 사용자가 질의하는 언어에 맞춰 최종 답변 언어를 동적으로 선택하라. (한국어 질의 $\rightarrow$ 한국어 응답, 영어 질의 $\rightarrow$ 영어 응답)
   - 단, [TOOL CALL], [THOUGHT], mcp__calendar__*, ▶, ✔, ⏱, ■, ●, ◆, ℹ, ✖ 등 터미널 디버그 로그, 시스템 특수문자 및 MCP 도구 명칭의 영문 표현은 사용자 언어와 관계없이 기존 영문 및 기호를 100% 그대로 유지하라.
"""
